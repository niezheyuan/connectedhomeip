...
struct PyCallBack_chip_Controller_OperationalCredentialsDelegate : public chip::Controller::OperationalCredentialsDelegate
{
    ...
    int GenerateNodeOperationalCertificate(const class chip::PeerId & a0, const class chip::Span<const unsigned char> & a1,
                                           long long a2, unsigned char * a3, unsigned int a4, unsigned int & a5) override
    {
