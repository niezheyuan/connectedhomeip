...
void bind_PyChip_2(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    { // fd_set file:sys/_types/_fd_def.h line:50
        ...
        cl.def("assign", (struct fd_set & (fd_set::*) (const struct fd_set &) ) & fd_set::operator=,
               "C++: fd_set::operator=(const struct fd_set &) --> struct fd_set &", pybind11::return_value_policy::automatic,
               pybind11::arg(""));
    }
    { // timeval file: line:29
        ...
        cl.def("assign", (struct timeval & (timeval::*) (const struct timeval &) ) & timeval::operator=,
               "C++: timeval::operator=(const struct timeval &) --> struct timeval &", pybind11::return_value_policy::automatic,
               pybind11::arg(""));
    }
}
