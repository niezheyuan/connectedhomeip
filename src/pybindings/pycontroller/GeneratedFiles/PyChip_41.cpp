...
void bind_PyChip_41(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    ...
    pybind11::enum_<chip::DeviceLayer::DeviceEventType::EventTypeRanges>(
        M("chip::DeviceLayer::DeviceEventType"), "EventTypeRanges", pybind11::arithmetic(),
        "Event Type Ranges\n\n Defines numeric ranges for event types based on their visibility to the application,\n an whether "
        "or not they are specific to a particular platform adaptation.")
    ...
    M("chip::DeviceLayer::DeviceEventType")
        .def("IsPublic", (bool (*)(unsigned short)) & chip::DeviceLayer::DeviceEventType::IsPublic,
             "C++: chip::DeviceLayer::DeviceEventType::IsPublic(unsigned short) --> bool", pybind11::arg("eventType"));

    // chip::DeviceLayer::DeviceEventType::IsInternal(unsigned short) file:platform/CHIPDeviceEvent.h line:83
    M("chip::DeviceLayer::DeviceEventType")
        .def("IsInternal", (bool (*)(unsigned short)) & chip::DeviceLayer::DeviceEventType::IsInternal,
             "C++: chip::DeviceLayer::DeviceEventType::IsInternal(unsigned short) --> bool", pybind11::arg("eventType"));

    // chip::DeviceLayer::DeviceEventType::IsPlatformSpecific(unsigned short) file:platform/CHIPDeviceEvent.h line:87
    M("chip::DeviceLayer::DeviceEventType")
        .def("IsPlatformSpecific", (bool (*)(unsigned short)) & chip::DeviceLayer::DeviceEventType::IsPlatformSpecific,
             "C++: chip::DeviceLayer::DeviceEventType::IsPlatformSpecific(unsigned short) --> bool", pybind11::arg("eventType"));

    // chip::DeviceLayer::DeviceEventType::IsPlatformGeneric(unsigned short) file:platform/CHIPDeviceEvent.h line:91
    M("chip::DeviceLayer::DeviceEventType")
        .def("IsPlatformGeneric", (bool (*)(unsigned short)) & chip::DeviceLayer::DeviceEventType::IsPlatformGeneric,
             "C++: chip::DeviceLayer::DeviceEventType::IsPlatformGeneric(unsigned short) --> bool", pybind11::arg("eventType"));

    // chip::DeviceLayer::DeviceEventType::PublicEventTypes file:platform/CHIPDeviceEvent.h line:102
    pybind11::enum_<chip::DeviceLayer::DeviceEventType::PublicEventTypes>(
        M("chip::DeviceLayer::DeviceEventType"), "PublicEventTypes", pybind11::arithmetic(),
    ...
    pybind11::enum_<chip::DeviceLayer::DeviceEventType::InternalEventTypes>(
        M("chip::DeviceLayer::DeviceEventType"), "InternalEventTypes", pybind11::arithmetic(),
