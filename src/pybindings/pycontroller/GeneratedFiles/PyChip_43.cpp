...
void bind_PyChip_43(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	pybind11::enum_<chip::DeviceLayer::DeviceEventType::PublicPlatformSpecificEventTypes>(M("chip::DeviceLayer::DeviceEventType"), "PublicPlatformSpecificEventTypes", pybind11::arithmetic(), "Enumerates platform-specific event types that are visible to the application.")
		.export_values();

;

	// chip::DeviceLayer::DeviceEventType::InternalPlatformSpecificEventTypes file: line:44
	pybind11::enum_<chip::DeviceLayer::DeviceEventType::InternalPlatformSpecificEventTypes>(M("chip::DeviceLayer::DeviceEventType"), "InternalPlatformSpecificEventTypes", pybind11::arithmetic(), "Enumerates platform-specific event types that are internal to the chip Device Layer.")
