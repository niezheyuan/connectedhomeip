...
void bind_PyChip_42(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    ...
    pybind11::enum_<chip::DeviceLayer::ConnectivityChange>(
        M("chip::DeviceLayer"), "ConnectivityChange", pybind11::arithmetic(),
    ...
    pybind11::enum_<chip::DeviceLayer::ActivityChange>(
        M("chip::DeviceLayer"), "ActivityChange", pybind11::arithmetic(),
    ...
    M("chip::DeviceLayer")
        .def("GetConnectivityChange",
             (enum chip::DeviceLayer::ConnectivityChange(*)(bool, bool)) & chip::DeviceLayer::GetConnectivityChange,
             "C++: chip::DeviceLayer::GetConnectivityChange(bool, bool) --> enum chip::DeviceLayer::ConnectivityChange",
             pybind11::arg("prevState"), pybind11::arg("newState"));
}
