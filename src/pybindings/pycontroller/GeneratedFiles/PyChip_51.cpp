...
void bind_PyChip_51(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("chip::TLV").def("ProfileTag", (unsigned long long (*)(unsigned int, unsigned int)) &chip::TLV::ProfileTag, "Generates the API representation of a profile-specific TLV tag from a profile id and tag number\n\n \n       The id of the profile within which the tag is defined.\n \n\n          The profile-specific tag number assigned to the tag.\n \n\n                      A 64-bit integer representing the tag.\n\nC++: chip::TLV::ProfileTag(unsigned int, unsigned int) --> unsigned long long", pybind11::arg("profileId"), pybind11::arg("tagNum"));

	// chip::TLV::ProfileTag(unsigned short, unsigned short, unsigned int) file:core/CHIPTLVTags.h line:102
	M("chip::TLV").def("ProfileTag", (unsigned long long (*)(unsigned short, unsigned short, unsigned int)) &chip::TLV::ProfileTag, "Generates the API representation of a profile-specific TLV tag from a vendor id, profile number and tag number\n\n \n        The id of the vendor that defined the tag.\n \n\n      The vendor assigned number for the profile within which the tag is defined.\n \n\n          The profile-specific tag number assigned to the tag.\n \n\n                      A 64-bit integer representing the tag.\n\nC++: chip::TLV::ProfileTag(unsigned short, unsigned short, unsigned int) --> unsigned long long", pybind11::arg("vendorId"), pybind11::arg("profileNum"), pybind11::arg("tagNum"));

	// chip::TLV::ContextTag(unsigned char) file:core/CHIPTLVTags.h line:114
	M("chip::TLV").def("ContextTag", (unsigned long long (*)(unsigned char)) &chip::TLV::ContextTag, "Generates the API representation for of context-specific TLV tag\n\n \n          The context-specific tag number assigned to the tag.\n \n\n                      A 64-bit integer representing the tag.\n\nC++: chip::TLV::ContextTag(unsigned char) --> unsigned long long", pybind11::arg("tagNum"));

	// chip::TLV::CommonTag(unsigned int) file:core/CHIPTLVTags.h line:125
	M("chip::TLV").def("CommonTag", (unsigned long long (*)(unsigned int)) &chip::TLV::CommonTag, "Generates the API representation of a common profile TLV tag\n\n \n          The common profile tag number assigned to the tag.\n \n\n                      A 64-bit integer representing the tag.\n\nC++: chip::TLV::CommonTag(unsigned int) --> unsigned long long", pybind11::arg("tagNum"));

	// chip::TLV::ProfileIdFromTag(unsigned long long) file:core/CHIPTLVTags.h line:149
	M("chip::TLV").def("ProfileIdFromTag", (unsigned int (*)(unsigned long long)) &chip::TLV::ProfileIdFromTag, "Returns the profile id from a TLV tag\n\n \n The behavior of this function is undefined if the supplied tag is not a profile-specific tag.\n\n \n             The API representation of a profile-specific TLV tag.\n \n\n                      The profile id.\n\nC++: chip::TLV::ProfileIdFromTag(unsigned long long) --> unsigned int", pybind11::arg("tag"));

	// chip::TLV::ProfileNumFromTag(unsigned long long) file:core/CHIPTLVTags.h line:162
	M("chip::TLV").def("ProfileNumFromTag", (unsigned short (*)(unsigned long long)) &chip::TLV::ProfileNumFromTag, "Returns the profile number from a TLV tag\n\n \n The behavior of this function is undefined if the supplied tag is not a profile-specific tag.\n\n \n             The API representation of a profile-specific TLV tag.\n \n\n                      The associated profile number.\n\nC++: chip::TLV::ProfileNumFromTag(unsigned long long) --> unsigned short", pybind11::arg("tag"));

	// chip::TLV::TagNumFromTag(unsigned long long) file:core/CHIPTLVTags.h line:178
	M("chip::TLV").def("TagNumFromTag", (unsigned int (*)(unsigned long long)) &chip::TLV::TagNumFromTag, "Returns the tag number from a TLV tag\n\n \n The behavior of this function is undefined if the supplied tag is not a profile-specific\n or context-specific tag.\n\n \n IsProfileTag() and IsContextTag()\n\n \n             The API representation of a profile-specific or context-specific TLV tag.\n \n\n                      The associated tag number.\n\nC++: chip::TLV::TagNumFromTag(unsigned long long) --> unsigned int", pybind11::arg("tag"));

	// chip::TLV::VendorIdFromTag(unsigned long long) file:core/CHIPTLVTags.h line:191
	M("chip::TLV").def("VendorIdFromTag", (unsigned short (*)(unsigned long long)) &chip::TLV::VendorIdFromTag, "Returns the vendor id from a TLV tag\n\n \n The behavior of this function is undefined if the supplied tag is not a profile-specific tag.\n\n \n             The API representation of a profile-specific TLV tag.\n \n\n                      The associated vendor id.\n\nC++: chip::TLV::VendorIdFromTag(unsigned long long) --> unsigned short", pybind11::arg("tag"));

	// chip::TLV::IsProfileTag(unsigned long long) file:core/CHIPTLVTags.h line:199
	M("chip::TLV").def("IsProfileTag", (bool (*)(unsigned long long)) &chip::TLV::IsProfileTag, "Returns true of the supplied tag is a profile-specific tag.\n\nC++: chip::TLV::IsProfileTag(unsigned long long) --> bool", pybind11::arg("tag"));

	// chip::TLV::IsContextTag(unsigned long long) file:core/CHIPTLVTags.h line:207
	M("chip::TLV").def("IsContextTag", (bool (*)(unsigned long long)) &chip::TLV::IsContextTag, "Returns true if the supplied tag is a context-specific tag.\n\nC++: chip::TLV::IsContextTag(unsigned long long) --> bool", pybind11::arg("tag"));

	// chip::TLV::IsSpecialTag(unsigned long long) file:core/CHIPTLVTags.h line:213
	M("chip::TLV").def("IsSpecialTag", (bool (*)(unsigned long long)) &chip::TLV::IsSpecialTag, "C++: chip::TLV::IsSpecialTag(unsigned long long) --> bool", pybind11::arg("tag"));

	// chip::TLV::TLVType file:core/CHIPTLVTypes.h line:33
	pybind11::enum_<chip::TLV::TLVType>(M("chip::TLV"), "TLVType", pybind11::arithmetic(), "An enumeration identifying the type of a TLV element.")
...
;
	...
	M("chip::TLV").def("IsValidTLVType", (bool (*)(enum chip::TLV::TLVElementType)) &chip::TLV::IsValidTLVType, "Returns true if the specified TLV type is valid.\n\n \n  if the specified TLV type is valid; otherwise \n \n\nC++: chip::TLV::IsValidTLVType(enum chip::TLV::TLVElementType) --> bool", pybind11::arg("type"));

	// chip::TLV::TLVTypeHasValue(enum chip::TLV::TLVElementType) file:core/CHIPTLVTypes.h line:131
	M("chip::TLV").def("TLVTypeHasValue", (bool (*)(enum chip::TLV::TLVElementType)) &chip::TLV::TLVTypeHasValue, "Returns true if the specified TLV type implies the presence of an associated value field.\n\n \n  if the specified TLV type implies the presence of an associated value field; otherwise \n \n\nC++: chip::TLV::TLVTypeHasValue(enum chip::TLV::TLVElementType) --> bool", pybind11::arg("type"));

	// chip::TLV::TLVTypeHasLength(enum chip::TLV::TLVElementType) file:core/CHIPTLVTypes.h line:142
	M("chip::TLV").def("TLVTypeHasLength", (bool (*)(enum chip::TLV::TLVElementType)) &chip::TLV::TLVTypeHasLength, "Returns true if the specified TLV type implies the presence of an associated length field.\n\n \n  if the specified TLV type implies the presence of an associated length field; otherwise \n \n\nC++: chip::TLV::TLVTypeHasLength(enum chip::TLV::TLVElementType) --> bool", pybind11::arg("type"));

	// chip::TLV::TLVTypeIsContainer(enum chip::TLV::TLVElementType) file:core/CHIPTLVTypes.h line:152
	M("chip::TLV").def("TLVTypeIsContainer", (bool (*)(enum chip::TLV::TLVElementType)) &chip::TLV::TLVTypeIsContainer, "Returns true if the specified TLV type is a container.\n\n \n  if the specified TLV type is a container; otherwise \n \n\nC++: chip::TLV::TLVTypeIsContainer(enum chip::TLV::TLVElementType) --> bool", pybind11::arg("type"));

	// chip::TLV::TLVTypeIsContainer(enum chip::TLV::TLVType) file:core/CHIPTLVTypes.h line:157
	M("chip::TLV").def("TLVTypeIsContainer", (bool (*)(enum chip::TLV::TLVType)) &chip::TLV::TLVTypeIsContainer, "C++: chip::TLV::TLVTypeIsContainer(enum chip::TLV::TLVType) --> bool", pybind11::arg("type"));

	// chip::TLV::TLVTypeIsString(enum chip::TLV::TLVElementType) file:core/CHIPTLVTypes.h line:167
	M("chip::TLV").def("TLVTypeIsString", (bool (*)(enum chip::TLV::TLVElementType)) &chip::TLV::TLVTypeIsString, "Returns true if the specified TLV type is a UTF8 or byte string.\n\n \n  if the specified TLV type is a UTF8 or byte string; otherwise \n \n\nC++: chip::TLV::TLVTypeIsString(enum chip::TLV::TLVElementType) --> bool", pybind11::arg("type"));

	// chip::TLV::GetTLVFieldSize(enum chip::TLV::TLVElementType) file:core/CHIPTLVTypes.h line:173
	M("chip::TLV").def("GetTLVFieldSize", (enum chip::TLV::TLVFieldSize (*)(enum chip::TLV::TLVElementType)) &chip::TLV::GetTLVFieldSize, "C++: chip::TLV::GetTLVFieldSize(enum chip::TLV::TLVElementType) --> enum chip::TLV::TLVFieldSize", pybind11::arg("type"));

	// chip::TLV::TLVFieldSizeToBytes(enum chip::TLV::TLVFieldSize) file:core/CHIPTLVTypes.h line:181
	M("chip::TLV").def("TLVFieldSizeToBytes", (unsigned char (*)(enum chip::TLV::TLVFieldSize)) &chip::TLV::TLVFieldSizeToBytes, "C++: chip::TLV::TLVFieldSizeToBytes(enum chip::TLV::TLVFieldSize) --> unsigned char", pybind11::arg("fieldSize"));
