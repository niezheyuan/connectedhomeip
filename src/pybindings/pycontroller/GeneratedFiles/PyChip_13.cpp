...
void bind_PyChip_13(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    ...
    M("chip").def("FormatCHIPError", (bool (*)(char *, unsigned short, int)) & chip::FormatCHIPError,
                  "C++: chip::FormatCHIPError(char *, unsigned short, int) --> bool", pybind11::arg("buf"),
    ...
    M("chip").def("ErrorStr", (const char * (*) (int) ) & chip::ErrorStr, "C++: chip::ErrorStr(int) --> const char *",
                  pybind11::return_value_policy::automatic, pybind11::arg("err"));
    ...
    M("chip").def("FormatError", (void (*)(char *, unsigned short, const char *, int, const char *)) & chip::FormatError,
                  "C++: chip::FormatError(char *, unsigned short, const char *, int, const char *) --> void", pybind11::arg("buf"),
                  pybind11::arg("bufSize"), pybind11::arg("subsys"), pybind11::arg("err"), pybind11::arg("desc"));

    // chip::StatusReportStr(unsigned int, unsigned short) file:support/ErrorStr.h line:47
    M("chip").def("StatusReportStr", (const char * (*) (unsigned int, unsigned short) ) & chip::StatusReportStr,
                  "C++: chip::StatusReportStr(unsigned int, unsigned short) --> const char *",
                  pybind11::return_value_policy::automatic, pybind11::arg("profileId"), pybind11::arg("statusCode"));
}
