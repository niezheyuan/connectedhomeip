...
void bind_PyChip_15(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	M("chip::Logging").def("Log", [](unsigned char const & a0, unsigned char const & a1, const char * a2) -> void { return chip::Logging::Log(a0, a1, a2); }, "", pybind11::arg("module"), pybind11::arg("category"), pybind11::arg("msg"));
	...
	// chip::Logging::GetMessageWithPrefix(char *, unsigned char, unsigned char, const char *) file:support/logging/CHIPLogging.h line:179
	M("chip::Logging").def("GetMessageWithPrefix", (void (*)(char *, unsigned char, unsigned char, const char *)) &chip::Logging::GetMessageWithPrefix, "C++: chip::Logging::GetMessageWithPrefix(char *, unsigned char, unsigned char, const char *) --> void", pybind11::arg("buf"), pybind11::arg("bufSize"), pybind11::arg("module"), pybind11::arg("msg"));
