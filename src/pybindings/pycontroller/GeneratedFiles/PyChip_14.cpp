...
void bind_PyChip_14(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    ...
    pybind11::enum_<chip::Logging::LogModule>(
        M("chip::Logging"), "LogModule", pybind11::arithmetic(),
        "Identifies a logical section of code that is a source of log\n    messages.\n\n  \n If you add modules or rearrange this "
        "list you must update the\n        ModuleNames tables in ChipLogging.cpp.\n\n ")
    ...
    pybind11::enum_<chip::Logging::LogCategory>(M("chip::Logging"), "LogCategory", pybind11::arithmetic(),
