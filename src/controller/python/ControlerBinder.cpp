...
PYBIND11_MODULE(CHIPController, root_module) {
 ...
 py::class_<chip::BitFlags<chip::RendezvousInformationFlag, uint8_t>>(root_module, "BitFlags")
    ...
    .def("RendezvousInformationFlag", &chip::BitFlags<chip::RendezvousInformationFlag, uint8_t>::operator chip::RendezvousInformationFlag);
  ...
  py::class_<chip::Controller::DeviceAddressUpdateDelegate, PyDeviceAddressUpdateDelegate /* <--- trampoline*/>(root_module, "PyDeviceAddressUpdateDelegate")
    .def(py::init<>())
    .def("OnAddressUpdateComplete", &chip::Controller::DeviceAddressUpdateDelegate::OnAddressUpdateComplete);
  py::class_<chip::Controller::DevicePairingDelegate, PyDevicePairingDelegate /* <--- trampoline*/>DevicePairingDelegate(root_module, "PyDevicePairingDelegate");
