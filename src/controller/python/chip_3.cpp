...
void bind_chip_3(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    ...
    { // chip::Controller::Device file:controller/CHIPDevice.h line:88
        ...
        cl.def("GetAddress",
               (bool (chip::Controller::Device::*)(class chip::Inet::IPAddress &, unsigned short &) const) &
                   chip::Controller::Device::GetAddress,
        ...
        cl.def(
            "Init",
            (void (chip::Controller::Device::*)(struct chip::Controller::ControllerDeviceInitParams, unsigned short,
                                                unsigned long long, const class chip::Transport::PeerAddress &, unsigned short)) &
                chip::Controller::Device::Init,
            "Initialize a new device object with secure session manager, inet layer object,\n   and other device specific "
            "parameters. This variant of function is typically used when\n   a new device is paired, and the corresponding device "
            "object needs to updated with\n   all device specifc parameters (address, port, interface etc).\n\n   This is not done "
            "as part of constructor so that the controller can have a list of\n   uninitialized/unpaired device objects. The "
            "object is initialized only when the device\n   is actually paired.\n\n \n       Wrapper object for transport manager "
            "etc.\n \n\n   Port on which controller is listening (typically CHIP_PORT)\n \n\n     Node ID of the device\n \n\n  "
            "The location of the peer. MUST be of type Transport::Type::kUdp\n \n\n        Local administrator that's initializing "
            "this device object\n\nC++: chip::Controller::Device::Init(struct chip::Controller::ControllerDeviceInitParams, "
            "unsigned short, unsigned long long, const class chip::Transport::PeerAddress &, unsigned short) --> void",
            pybind11::arg("params"), pybind11::arg("listenPort"), pybind11::arg("deviceId"), pybind11::arg("peerAddress"),
            pybind11::arg("admin"));
        cl.def("Serialize",
        ...
        cl.def("ProvisioningComplete",
               (void (chip::Controller::Device::*)(unsigned short)) & chip::Controller::Device::ProvisioningComplete,
               "C++: chip::Controller::Device::ProvisioningComplete(unsigned short) --> void", pybind11::arg("caseKeyId"));
        cl.def("IsProvisioningComplete",
               (bool (chip::Controller::Device::*)() const) & chip::Controller::Device::IsProvisioningComplete,
               "C++: chip::Controller::Device::IsProvisioningComplete() const --> bool");
        ...
        cl.def("GenerateCSRNonce", (int (chip::Controller::Device::*)()) & chip::Controller::Device::GenerateCSRNonce,
               "C++: chip::Controller::Device::GenerateCSRNonce() --> int");
    }
