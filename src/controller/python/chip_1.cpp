...
void bind_chip_1(std::function<pybind11::module &(std::string const & namespace_)> & M)
{
    ...
    { // chip::Transport::PeerAddress file:transport/raw/PeerAddress.h line:61
        ...
        cl.def(pybind11::init<const class chip::Inet::IPAddress &, enum chip::Transport::Type>(), pybind11::arg("addr"),
               pybind11::arg("type"));
        ...
        cl.def("GetIPAddress",
               (const class chip::Inet::IPAddress & (chip::Transport::PeerAddress::*) () const) &
                   chip::Transport::PeerAddress::GetIPAddress,
               "C++: chip::Transport::PeerAddress::GetIPAddress() const --> const class chip::Inet::IPAddress &",
               pybind11::return_value_policy::automatic);
        cl.def("SetIPAddress",
               (class chip::Transport::PeerAddress & (chip::Transport::PeerAddress::*) (const class chip::Inet::IPAddress &) ) &
                   chip::Transport::PeerAddress::SetIPAddress,
               "C++: chip::Transport::PeerAddress::SetIPAddress(const class chip::Inet::IPAddress &) --> class "
               "chip::Transport::PeerAddress &",
               pybind11::return_value_policy::automatic, pybind11::arg("addr"));
        ...
        cl.def_static(
            "UDP", (class chip::Transport::PeerAddress(*)(const class chip::Inet::IPAddress &)) & chip::Transport::PeerAddress::UDP,
            "C++: chip::Transport::PeerAddress::UDP(const class chip::Inet::IPAddress &) --> class chip::Transport::PeerAddress",
            pybind11::arg("addr"));
        cl.def_static("UDP",
                      (class chip::Transport::PeerAddress(*)(const class chip::Inet::IPAddress &, unsigned short)) &
                          chip::Transport::PeerAddress::UDP,
                      "C++: chip::Transport::PeerAddress::UDP(const class chip::Inet::IPAddress &, unsigned short) --> class "
                      "chip::Transport::PeerAddress",
                      pybind11::arg("addr"), pybind11::arg("port"));
        cl.def_static("UDP",
                      (class chip::Transport::PeerAddress(*)(const class chip::Inet::IPAddress &, unsigned short, unsigned int)) &
                          chip::Transport::PeerAddress::UDP,
                      "C++: chip::Transport::PeerAddress::UDP(const class chip::Inet::IPAddress &, unsigned short, unsigned int) "
                      "--> class chip::Transport::PeerAddress",
                      pybind11::arg("addr"), pybind11::arg("port"), pybind11::arg("interface"));
        cl.def_static(
            "TCP", (class chip::Transport::PeerAddress(*)(const class chip::Inet::IPAddress &)) & chip::Transport::PeerAddress::TCP,
            "C++: chip::Transport::PeerAddress::TCP(const class chip::Inet::IPAddress &) --> class chip::Transport::PeerAddress",
            pybind11::arg("addr"));
        cl.def_static("TCP",
                      (class chip::Transport::PeerAddress(*)(const class chip::Inet::IPAddress &, unsigned short)) &
                          chip::Transport::PeerAddress::TCP,
                      "C++: chip::Transport::PeerAddress::TCP(const class chip::Inet::IPAddress &, unsigned short) --> class "
                      "chip::Transport::PeerAddress",
                      pybind11::arg("addr"), pybind11::arg("port"));
        cl.def_static("TCP",
                      (class chip::Transport::PeerAddress(*)(const class chip::Inet::IPAddress &, unsigned short, unsigned int)) &
                          chip::Transport::PeerAddress::TCP,
                      "C++: chip::Transport::PeerAddress::TCP(const class chip::Inet::IPAddress &, unsigned short, unsigned int) "
                      "--> class chip::Transport::PeerAddress",
                      pybind11::arg("addr"), pybind11::arg("port"), pybind11::arg("interface"));
    }
}
